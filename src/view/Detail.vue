<template>
  <div id="product">
    <Navbar />
    <h1 style="text-align: center">Ini Halaman Detail Page</h1>
    <!-- Data Motor -->
    <div class="data-motor">
      <div class="input" id="input"></div>
      <div class="data">
        <h1 style="text-align:center;">Data Motor</h1>
        <button
          type="button"
    ...
    <div class="data-mobil">
      ...
      <div class="data">
        ...
        <button
          ...
          class="btn btn-success add"
          data-bs-toggle="modal"
          data-bs-target="#staticBackdropmobil"
        >
          ADD
        </button>
        <div
          class="modal fade"
          id="staticBackdropmobil"
          data-bs-backdrop="static"
          data-bs-keyboard="false"
          tabindex="-1"
          aria-labelledby="staticBackdropmobil"
          aria-hidden="true"
        >
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropmobil">
          ...
          <tbody>
            <tr v-for="(mobil, index) in mobils" :key="mobil.id">
              ...
              <td>
                ...
                <button class="del" @click="del1(mobil)">
                  <i class="fa-solid fa-trash"></i>
                </button>
              </td>
            </tr>
